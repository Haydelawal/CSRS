  ...
  <div class="container my-5 mt-5 mx-5 px-5">
    ...
    <form method="post">
        ...
        <div class="field">
            ...
            <textarea name="main" id="message" rows="5" class="textarea is-medium" placeholder="Report Body Goes Here"></textarea>
        </div>
        <br>
        <button type="submit" name="submit" class="button is-success is-size-5">Submit</button>
    </form>
</div>
<!-- partial -->
